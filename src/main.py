...
parser.add_argument('--photoshop_host', default='localhost')
parser.add_argument('--photoshop_port', default='49494')
parser.add_argument('--photoshop_password', default='123456')
parser.add_argument('--basnet_service_ip', required=True,
                    help="The BASNet service IP address")
parser.add_argument('--basnet_service_host',
                    help="Optional, the BASNet service host")
...
def ping():
    logging.info('ping')
    r = requests.get(args.basnet_service_ip, headers={
                     'Host': args.basnet_service_host})
...
def paste():
    ...
    if found:
        ...
        ps.paste(img_path, name, x, y, password=args.photoshop_password,
                 host=args.photoshop_host, port=args.photoshop_port)
    else:
